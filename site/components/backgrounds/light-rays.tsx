...
/**
 * LightRays, from React Bits (https://reactbits.dev/backgrounds/light-rays), as
 * Background Studio exports it. Copyright (c) 2026 David Haz.
 *
 ...
 *
 * Changed from upstream only where this project's stricter TypeScript settings
 * reject the original, where a single match or observer entry could be undefined,
 * and to a named export.
 */
