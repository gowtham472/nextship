...
**Version 0.4.2.** v0.4 is complete and verified against a live deployment. v0.5 is started, not finished: the driver interface exists, the AWS driver does not.
